...
a904f686-e79e-4aae-8725-f06d6ffc3d8c
...
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/bcabaf5d-a743-410e-bff8-a4d9d3c8014b" />

### 📥 Upload Page (Single Camera)  
> **UI for uploading a single video for tracking players using YOLO and SORT.**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/5af295b5-a05a-469c-9886-9fe221a653d3" />
...
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/8c30d1a3-234f-40a1-927f-2e856dd35e66" />

### 🎞️ Input Video (Single Camera)  
> **Original video from a single feed (e.g., Broadcast camera) to be processed for player tracking.**
<img width="1366" height="563" alt="Image" src="https://github.com/user-attachments/assets/98d81273-16f7-4409-8933-00602df08b5e" />

### 🧵 Output Video (Single Camera)  
> **Resulting video showing tracked players with persistent IDs within the same camera.**
<img width="1366" height="542" alt="Image" src="https://github.com/user-attachments/assets/dc41c758-3b4e-4fee-9f17-b9405b136634" />

### 🎥 Input Videos (Cross Camera)  
> *Three videos used for multi-camera player re-identification:*
> - **Broadcast Camera View**
<img width="1366" height="662" alt="Image" src="https://github.com/user-attachments/assets/5b4e6b62-4267-4939-b713-9de75a88395a" />

> - **Tacticam Camera View**
<img width="1366" height="461" alt="Image" src="https://github.com/user-attachments/assets/f6a1aba4-33bc-44c0-8b19-db9327bf9e31" />

> - **Main Camera View**
<img width="1366" height="463" alt="Image" src="https://github.com/user-attachments/assets/0755a81b-2c66-4fc2-a63d-791afb6bf472" />
...
<img width="1366" height="623" alt="Image" src="https://github.com/user-attachments/assets/6ed8085e-85c2-4d9d-913d-18adfadbce52" />
---
...
├── README.md
├── docs
| ├── Project Report # Report of the Project
| └── Project Vedio # Vedio of the Project
│
|── data/
| └── uploads\ # Storing Uploading Vedio on the User Interface
...
├── static/
│ ├── outputs/
│ │ ├── reid_single/ # Storing Single Camera Outputs Vedio
|     └── annotated_overview.mp4
│ │ └── reid_cross/  # Storing Cross Camera Outputs Vedio
|     └── combined_vedio.mp4
│ ├── styles.css
| └── scripts.js
│
...
cd /Project Folder Name/player-reid-webapp
...
### 📦 Optional:
To make the screenshots and demo video fully visible:
- Upload images (`screenshot_home.png`, etc.) to `static/uploads/`
- Upload demo video as `demo.mp4` or host on YouTube

---

Would you like me to generate the screenshots automatically from your web app or design demo images using mock c
